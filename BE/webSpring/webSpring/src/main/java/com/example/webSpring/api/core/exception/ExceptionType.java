...
public enum ExceptionType {
    ...
    NOT_FOUND_PUBLISHING_COMPANY("validation.notFoundPublishingCompany", null),
    NOT_FOUND_AUTHOR("validation.notFoundAuthor", null),
    NOT_FOUND_CATEGORY("validation.notFoundCategory", null);
